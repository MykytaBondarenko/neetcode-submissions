...
Put all the array elements into a HashSet
A number can be a "start of a sequence" only if there is no num-1 in the set
If we find a number like this, we start checking how many consequtive nums there are after that
